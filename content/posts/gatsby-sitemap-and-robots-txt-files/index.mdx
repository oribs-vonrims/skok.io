...
import ProjectTreePartFour from "./components/project-tree"
...
Make yourself familiar with the folder structure and the files we will update in part 4.
...
`robots.txt` is generated in the root of your website `http://<SITE_URL>/robots.txt`. With the above configuration your production
`robots.txt` will look, like:
