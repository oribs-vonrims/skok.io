...
This is a 4 part series of posts about building [SEO-optimized Gatsby blog](https://gatsby-seo-draft.netlify.com)
with [theme-ui](https://theme-ui.com/getting-started) and [MDX](https://mdxjs.com).
...
As well as other cases that we don't really care about with the current URL structure.
